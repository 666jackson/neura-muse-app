...
export const T = {
  en: {
    ...
    dropImages: 'DRAG IMAGES HERE — from Photos or Finder', dropVideos: 'DRAG VIDEOS HERE — from Photos or Finder', dropMany: 'DROP ONE OR MANY · OR CLICK TO BROWSE',
  ...
  zh: {
    ...
    dropImages: '把圖片拖到這裡 — 從相簿或 Finder 直接拉入', dropVideos: '把影片拖到這裡 — 從相簿或 Finder 直接拉入', dropMany: '可一次拖入多個檔案 · 或點擊選取',
  ...
  ja: {
    ...
    dropImages: '画像をここにドラッグ — 写真アプリや Finder から', dropVideos: '動画をここにドラッグ — 写真アプリや Finder から', dropMany: '複数まとめてドロップ可 · またはクリックで選択',
